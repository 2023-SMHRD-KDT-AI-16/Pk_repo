...
public class DTO {
	...
	String [][] SandWitch = {{"베이글", "식빵", "치아바타", "호밀", "플렛", "라이스페이퍼"},
	...
	// 전골 {{재료}, {소스}} 2차원 배열
	String[][] Nabe = {{"만두", "난자완스", "떡", "라면사리", "숙주", "두부", "버섯", "소고기", "미나리", "쑥갓", "노른자", "청경채", "당면", "곱창", "무", "마늘", "대파"},
					   {"마라", "로제", "크림", "민트", "초콜릿", "닭육수", "된장", "소유", "어묵국물", "김칫국물"}};

	
	
	// 샌드위치 , 피자 , 전골 getter / setter 
